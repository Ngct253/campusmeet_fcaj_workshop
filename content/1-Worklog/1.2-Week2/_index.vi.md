...
- Tìm hiểu Amazon VPC và kết nối VPN.
- Thực hành khởi tạo, cấu hình và quản lý EC2 Instance chạy Windows và Linux.
- Triển khai ứng dụng Node.js cơ bản trên Amazon EC2.
- Tìm hiểu cách giới hạn quyền truy cập EC2 bằng IAM và dọn dẹp tài nguyên.
...
- Hiểu vai trò và các thành phần cơ bản của Amazon VPC.
- Làm quen với quy trình thiết lập kết nối VPN.
- Khởi tạo và thực hiện các thao tác quản lý cơ bản trên EC2 Instance chạy Windows và Linux.
- Thực hành triển khai ứng dụng Node.js cơ bản trên hai môi trường EC2.
- Tìm hiểu cách giới hạn quyền truy cập tài nguyên EC2 bằng IAM.
- Biết kiểm tra và dọn dẹp các tài nguyên VPC, VPN và EC2 sau khi hoàn thành.
