...
This workshop presents CampusMeet from a product perspective, focusing on the problem, users, high-level architecture, current features, and meeting journey. Source code, commands, configuration values, and API paths have been removed.

### Objectives

After reading the workshop, readers should be able to:

- Explain the problem CampusMeet addresses and identify its intended users.
...
2. [Users and objectives](5.2-Prerequiste/)
